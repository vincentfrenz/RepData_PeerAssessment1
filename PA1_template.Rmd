...
activityDataComplete[is.na(steps), "steps"] <- activityDataComplete[, c(lapply(.SD, median, na.rm = TRUE)), .SDcols = c("steps")]
activityDataCompleteInterval <- activityDataComplete[, c(lapply(.SD, mean, na.rm = TRUE)), .SDcols = c("steps"), by = .(interval, `weekdayOrweekend`)] 
